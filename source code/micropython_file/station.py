...
class stationClass():
    ...
    def get_status(self):
        ...
        url = "http://192.168.1.13:5000/station?station="+str(self.station_num)
...
if __name__ == "__main__":
    ...
    station = stationClass(led_pin=2,coming_pin=16,arrived_pin=17,station_num=1)
    
    station.connect_to_wlan("PAT_T","NoppanutT.")
